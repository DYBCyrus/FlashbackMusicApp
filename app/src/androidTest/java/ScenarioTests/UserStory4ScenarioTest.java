...
public class UserStory4ScenarioTest {
    ...
    @Test
    public void userStory3ScenarioTest() {
        ...
        ViewInteraction appCompatButton3 = onView(
                allOf(withId(R.id.back), withText("NORMAL"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.design.widget.CoordinatorLayout")),
                                        1),
...
//                allOf(withId(R.id.track_names), withText("Spiraling Stars"),
//                        childAtPosition(
//                                childAtPosition(
